...
export const BOARD_OFFSET_Y = 106;
...
// Frame indices within icons_action.png (128x16 = 8 frames of 16x16),
// matching ResourceManager#getActionIcon usage in the original's ActionButtonBar.java.
// REPAIR deliberately shares OCCUPY's frame (1) - the original's own
// btn_repair reuses getActionIcon(1) too, same house icon as btn_occupy.
export const ACTION_ICON = { BUY: 0, OCCUPY: 1, REPAIR: 1, ATTACK: 2, SUMMON: 3, STANDBY: 5, SUPPORT: 6, HEAL: 7 };
...
export const DEPTH = {
  TILES: 0,
  TOMBS: 5, // below units, above tiles - matches GameScreen#drawTombs being called right before drawUnits in the original
  UNITS: 10,
